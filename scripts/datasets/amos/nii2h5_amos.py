...
def main():
    mode = 'u'
    if mode == 'l':
        nii_imgpath = "E:/AMOS-Lab/AMOS22/labeled_preprocess/images" # AK
        nii_maskpath = 'E:/AMOS-Lab/AMOS22/labeled_preprocess/labels' # AK
        h5_save_path = 'E:/AMOS-Lab/AMOS22/labeled_h5' # AK
        ...
        nii_imgpath = 'E:/AMOS-Lab/AMOS22/unlabeled_preprocess' # AK
        h5_save_path = 'E:/AMOS-Lab/AMOS22/unlabeled_h5' # AK
